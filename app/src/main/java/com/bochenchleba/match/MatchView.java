...
public class MatchView extends android.support.v7.widget.AppCompatImageButton {
    ...
    public MatchView(Context context, AttributeSet attrs) {
        ...
        this.animate()
                .alpha(1.0f)
                .setDuration(Consts.ANIM_BUTTON_ALPHA_DURATION);
    }
    ...
    public void setBgrd (int imgsSetId, int randomNumber){

        switch (imgsSetId) {

            case Consts.IMGS_SET_ID_ANIMALS:
            ...
            case Consts.IMGS_SET_ID_NATURE:
                switch (randomNumber) {
                    case 0:
                        resizedBitmap = BitmapResizer.decodeSampledBitmapFromResource(
            ...
            case Consts.IMGS_SET_ID_WEATHER:
                switch (randomNumber) {
                    case 0:
                        resizedBitmap = BitmapResizer.decodeSampledBitmapFromResource(
                ...
                break;
            case Consts.IMGS_SET_ID_LETTERS:
                switch (randomNumber) {
                    case 0:
                        resizedBitmap = BitmapResizer.decodeSampledBitmapFromResource(
                        ...
                        //setBackgroundResource(R.drawable.lettera);
                        break;
                    case 1:
                        resizedBitmap = BitmapResizer.decodeSampledBitmapFromResource(
